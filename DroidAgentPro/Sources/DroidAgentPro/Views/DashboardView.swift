        ...
        NavigationView {
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    VStack(spacing: 8) {
                        HStack(spacing: 8) {
                            AppButton(title: state.isRecording ? "Stop Rec" : "Record",
                            ...
                            AppButton(title: state.isRunning ? "Running..." : "Run Agent",
        ...
        NavigationView {
            ScrollView {
                VStack(spacing: 14) {
                    ...
                    AppButton(title: "Save & Close", style: .green, isFullWidth: true) {
                        dismiss()
                    }
                    AppCard {
